...
/**
 * Used to search for all jobs as the Candidate user type. Implements the
...
public class CandidateAllJobsSearch implements SearchBehaviour {
    ...
    /**
     * Used to validate fields related to the job search.
     *
     * @param minSalary minimum salary to be checked
     * @param paginate pagination to check
     * @param paginateLength length of pagination to check
     * @return
     */
     ...
     * @return String representing Json Field
     */
