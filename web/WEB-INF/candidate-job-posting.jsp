...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <div role="tablist" id="accordion-1" class="accordion-flush">
                <div class="card" data-aos="fade-up">
                    <div class="card-header" role="tab">
                        ...
                        <h5 class="d-flex justify-content-end"><a data-bs-toggle="collapse" aria-expanded="true"
                                                                  aria-controls="accordion-1 .item-1"
                                                                  href="#accordion-1 .item-1"
                                                                  class="accordion-button"></a></h5>
                    </div>
                    <div class="collapse show item-1" role="tabpanel" data-bs-parent="#accordion-1">
                        <div class="card-body">
                            <div class="shadow job-post">
                                ...
                                <div>
                                    <h4>Requirements</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, velit.<br>
                                    </p>
                                    <hr>
                                </div>
                                <div class="row">
