...
<div class="container">
    <div class="row text-start d-flex flex-column flex-md-row head-row">
        <div class="col"><a href="#">
            ...
            <p><br>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                et dolore magna aliqua. Venenatis cras sed felis eget velit aliquet sagittis id. Diam phasellus
                vestibulum lorem sed risus ultricies. Sit amet dictum sit amet justo donec enim. Egestas dui id ornare
                arcu odio ut.<br><br></p>
            <hr>
        ...
        <div class="col">
            ...
            <div class="shadow job-post">
                <div class="d-flex flex-column align-items-baseline justify-content-md-between flex-lg-row job-header">
                    <span class="badge rounded-pill bg-secondary stat-badge">Full-Time</span>
                ...
                <div>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                        labore et dolore magna aliqua. Venenatis cras sed felis eget velit aliquet sagittis id. Diam
                        phasellus vestibulum lorem sed risus ultricies. Sit amet dictum sit amet justo donec enim.
                        Egestas dui id ornare arcu odio ut.<br></p>
                    <hr>
                </div>
                <div>
                    <h4>Requirements</h4>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" role="tab">
                        <button class="accordion-button" data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-1"
                                aria-expanded="true" aria-controls="accordion-1 .item-1">Candidate ID: 123456789
                        </button>
                    </h2>
