            ...
            <div class="row header-row">
                <div class="shadow job-post">
                    ...
                    <div class="row header-row" style="margin-bottom: 0;">
                        ...
                        <div class="col-md-5 offset-md-2 d-flex justify-content-between align-items-baseline"><i class="far fa-money-bill-alt icons"></i>
                            <p>$50,000 year</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row header-row">
                <div class="col">
                    <div role="tablist" id="accordion-1">
                        <div class="card">
                            <div class="card-header" role="tab">
                                <h5 class="mb-0"><a data-bs-toggle="collapse" aria-expanded="true" aria-controls="accordion-1 .item-1" href="#accordion-1 .item-1" class="candidate-name accordion-button">Candidate ID: 123456789</a></h5>
                            </div>
                            <div class="collapse show item-1 item-content" role="tabpanel" data-bs-parent="#accordion-1">
                                <div class="card-body">
                                    <div class="row candidate-row">
                                    ...
                                    <div class="btn-group float-end btn-group" role="group"><button class="btn btn-danger open-work" type="button">Reject</button><button class="btn btn-primary submit-btn" type="button">Setup Interview</button></div>
                                </div>
                            </div>
                        </div>
                    </div>
