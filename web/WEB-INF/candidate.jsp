                      ...
                      <div class="row" id="roles">
                          <div class="col">
                              <div class="d-flex flex-row justify-content-between align-items-baseline">
                                  ...
                                  <div class="popup role">
                                      <div class="border rounded popup-content">
                                          ...
                                          <form class="ignore popup-form">
                                              <div class="row d-flex justify-content-around align-items-center">
                                                  <div class="col"><select class="form-select level-slc" name="education-lvl">
                                  ...
                                  <button class="btn btn-outline-success open-role" type="submit"><i class="fas fa-plus-circle"
                                                                                                     value="addSkill"></i>
                                  </button>
                              </div>
                              <hr/>
                              <form class="shadow-sm d-flex justify-content-between align-items-baseline skill-form">
                                  ...
                                  <div class="d-sm-flex d-xl-flex justify-content-sm-end justify-content-xl-end modify-btns">
                                      <div role="group" class="btn-group">
                                          <button class="btn" data-bs-toggle="tooltip" type="submit" title="Delete"><i
...
<%--                <div class="d-sm-flex d-xl-flex justify-content-sm-end justify-content-xl-end modify-btns">--%>
<%--                    <div class="btn-group" role="group">--%>
<%--                        <div class="btn-group" role="group"><a class="btn" role="button" data-toggle="tooltip"--%>
<%--                                                               data-bss-tooltip="" title="Edit"--%>
<%--                                                               href="<c:url value="/candidate-profile-edit"/>"><i--%>
...
<%--                                    <div class="col-md-6"><input class="form-control" type="text" name="institution"--%>
<%--                                                                 autofocus="" title="Institution"--%>
<%--                                                                 value="${requestScope.education.institution}"--%>
...
<%--                                    <div class="col-md-6"><input class="form-control" type="text" name="subject"--%>
<%--                                                                 autocomplete="off"--%>
<%--                                                                 value="${requestScope.education.subject}"></div>--%>
<%--                                </div>--%>
<%--                                <div class="form-row d-flex justify-content-around">--%>
<%--                                    <div class="col-md-6"><label class="col-form-label"> Start Date</label></div>--%>
...
<%--                                <div class="form-row d-flex justify-content-around">--%>
<%--                                    <div class="col-md-6"><label class="col-form-label">End Date</label></div>--%>
<%--                                    <div class="col-md-6"><input class="form-control" name="end-date"--%>
<%--                                                                 value="<fmt:formatDate value="${requestScope.education.endDate}" type="date" pattern="yyyy-MM-dd" />"--%>
<%--                                                                 title="Institution" type="date"></div>--%>
<%--                                </div>--%>
<%--                                <div class="btn-group d-flex popup-btns" role="group">--%>
...
<%--                    </div>--%>
<%--                </div>--%>
<%--                <button class="btn btn-outline-success open-edu" data-bss-hover-animate="pulse" type="submit"--%>
<%--                        id="add-education-cta"><i--%>
...
<%--                    <div class="d-sm-flex d-xl-flex justify-content-sm-end justify-content-xl-end modify-btns">--%>
<%--                        <div class="btn-group" role="group">--%>
<%--                            <button class="btn" data-toggle="tooltip" type="submit" name="submit" value="delete"--%>
<%--                                    title="Delete"><i--%>
<%--                                    class="far fa-window-close"></i></button>--%>
<%--                            <button class="btn" data-toggle="tooltip" type="submit" name="submit" value="edit"--%>
<%--                                    title="Edit"><i--%>
...
<%--                                                             autofocus="" title="Institution"--%>
<%--                                                             value="${requestScope.workHistory.company}"></div>--%>
<%--                            </div>--%>
<%--                            <div class="form-row d-flex justify-content-around">--%>
<%--                                <div class="col-md-6"><label class="col-form-label">Title</label></div>--%>
<%--                                <div class="col-md-6"><input class="form-control" type="text" name="title"--%>
<%--                                                             value="${requestScope.workHistory.title}"></div>--%>
<%--                            </div>--%>
<%--                            <div class="form-row d-flex justify-content-around">--%>
<%--                                <div class="col-md-6"><label class="col-form-label">Start Date</label></div>--%>
...
<%--                            <div class="form-row d-flex justify-content-around">--%>
<%--                                <div class="col-md-6"><label class="col-form-label">End Date</label></div>--%>
<%--                                <div class="col-md-6"><input class="form-control" name="end-date" title="Institution"--%>
<%--                                                             value="<fmt:formatDate value="${requestScope.workHistory.endDate}" type="date" pattern="yyyy-MM-dd" />"--%>
<%--                                                             type="date"></div>--%>
<%--                            </div>--%>
<%--                            <div class="form-row d-flex justify-content-around">--%>
<%--                                <div class="col-md-6"><label class="col-form-label">Reference</label></div>--%>
<%--                                <div class="col-md-6"><input class="form-control" type="email" name="reference"--%>
<%--                                                             value="${requestScope.workHistory.reference}"></div>--%>
<%--                            </div>--%>
<%--                            <div class="btn-group d-flex popup-btns" role="group">--%>
<%--                                <button class="btn btn-secondary" type="reset">Reset</button>--%>
<%--                                <button class="btn btn-success" type="submit" name="submit" value="add">Add</button>--%>
...
<%--                        <p>${workHistory.title}</p>--%>
<%--                        <p>--%>
<%--                        <p><fmt:formatDate value="${workHistory.startDate}" type="date" pattern="yyyy-MM-dd"/> &rarr;--%>
<%--                            <c:choose>--%>
<%--                                <c:when test="${workHistory.endDate !=null}">--%>
...
<%--                                    <c:forEach var="skill" items="${skills}">--%>
<%--                                        <option value="${skill.skillID}"--%>
<%--                                                <c:if test='${skills.get(0)==skill}'>selected=""</c:if>>${skill.description}</option>--%>
<%--                                    </c:forEach>--%>
...
<%--                    </div>--%>
<%--                </div>--%>
<%--                <button class="btn btn-outline-success open-skill" data-bss-hover-animate="pulse" type="submit"--%>
<%--                        id="add-skills-cta"><i--%>
...
<%--            </c:if>--%>
<%--            <c:forEach var="candidateSkill" items="${candidate.candidateSkillList}">--%>
<%--                <form class="form-inline justify-content-between" action="<c:url value='/candidate-profile'/>"--%>
<%--                      method="POST">--%>
<%--                    <input type="hidden" name="form_name" value="skills"/>--%>
<%--                    <input type="hidden" name="id" value="${candidateSkill.canskillID}"/>--%>
<%--                    <input type="hidden" name="action" value="profilePageAction"/>--%>
