                ...
                <div class="row" id="roles">
                    <div class="col">
                            ...
                            <div class="popup role">
                                <div class="border rounded popup-content"><button
                                    ...
                                    <form class="ignore popup-form">
                                        ...
                                        <div class="btn-group d-flex popup-btns" role="group"><button
                                                class="btn btn-secondary" type="reset">Reset</button><button
                                                class="btn btn-success" type="submit">Add</button></div>
                                    </form>
                                </div>
                            </div><button class="btn btn-outline-success open-role" data-bss-hover-animate="pulse"
                                type="submit"><i class="fas fa-plus-circle" data-bss-hover-animate="pulse"
                        ...
                        <form class="shadow-sm d-flex justify-content-between align-items-baseline skill-form"
                            ...
                            <div class="d-sm-flex d-xl-flex justify-content-sm-end justify-content-xl-end modify-btns">
                                <div class="btn-group" role="group"><button class="btn" data-bs-toggle="tooltip"
                                        data-bss-tooltip="" type="submit" title="Delete"><i class="far fa-window-close"
                                            data-bss-hover-animate="pulse"></i></button></div>
                            </div>
                        </form>
                    </div>
                </div>
