                    ...
                    <form data-aos="fade-up" class="info-form">
                        ...
                        <div class="d-sm-flex d-xl-flex justify-content-sm-end justify-content-xl-end modify-btns">
                            <div class="btn-group" role="group">
                                <button class="btn" data-toggle="tooltip" type="submit" title="Edit" name="editBtn" value="editInfo"><i class="far fa-edit"></i>
                                </button>
                            </div>
                        </div>
                    </form>
                    ...
                    <c:forEach var="workHistory" items="${candidate.workHistoryCollection}">
                        <form data-aos="fade-up">
                            ...
                            <div class="d-flex d-sm-flex d-xl-flex justify-content-end modify-btns">
                                <div class="btn-group" role="group">
                                    <button class="btn" data-toggle="tooltip" type="submit" title="Delete" name="deleteBtn" value="deleteWorkHistory"><i
                                            class="far fa-window-close"></i></button>
                                    <button class="btn" data-toggle="tooltip" type="submit" title="Edit" name="editBtn" value="editWorkHistory"><i
                                            class="far fa-edit"></i></button>
                                </div>
                            </div>
                        </form>
                ...
                <div class="col-12 col-md-5 offset-md-2 sections">
                    ...
                    <c:forEach var="candidateSkill" items="${candidate.candidateSkillCollection}">
                        <form class="form-inline justify-content-between" data-aos="fade-up">
                            ...
                            <div class="d-sm-flex d-xl-flex justify-content-sm-end justify-content-xl-end modify-btns">
                                <div class="btn-group" role="group">
                                    <button class="btn" data-toggle="tooltip" type="submit" title="Delete" name="deleteBtn" value="deleteSkill"><i
                                            class="far fa-window-close"></i></button>
                                    <button class="btn" data-toggle="tooltip" type="submit" title="Edit" name="editBtn" value="editSkill"><i
                                            class="far fa-edit"></i></button>
                                </div>
                            </div>
                        </form>
