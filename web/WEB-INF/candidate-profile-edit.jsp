                ...
                <div class="col-12 col-lg-10 offset-lg-1">
                    <div class="d-md-flex flex-md-row-reverse">
                        <ul class="nav nav-tabs d-flex flex-column edit-items" role="tablist">
                            ...
                            <li class="nav-item" role="presentation"><a class="nav-link" role="tab" data-toggle="tab" id="edit-education-cta"
                                                                        href="#tab-2">Education</a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link" role="tab" data-toggle="tab" id="edit-workHistory-cta"
                                        ...
                                        <div class="border rounded popup-content">
                                            ...
                                            <form class="ignore popup-form" action="<c:url value='/candidate-profile'/>" method="post">
                                                ...
                                                <div role="group" class="btn-group d-flex popup-btns">
                                                    <button class="btn btn-danger" type="submit" name="submit" value="deleteCandidate">Permanently Remove My
                                                        Account 
                                                    </button>
                                                </div>
                                            </form>
                                ...
                                <form class="edit-form"  action="<c:url value='/candidate-profile'/>" method="post">
                                    ...
                                    <div class="form-row">
                                        <div class="col-12 col-md-5">
                                            <div class="form-group"><label for="firstName">First Name</label><input
                                                    class="form-control" type="text" id="firstName" name="firstName" value="<c:out value='${candidate.canfirstName}' default=''/>"></div>
                                        </div>
                                        <div class="col-12 col-md-5 offset-md-1">
                                            <div class="form-group"><label for="lastName">Last Name</label><input
                                                    class="form-control" type="text" id="lastName" name="lastName" value="<c:out value='${candidate.canlastName}' default=''/>"></div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-12 col-md-5">
                                        ...
                                        <div class="col-12 col-md-5 offset-md-1">
                                            <div class="form-group"><label id="email" for="status">Status</label><select
                                                    ...
                                                    <option value="yes"<c:if test="${candidate.placed==true}">selected</c:if>>Hired</option>
                                                    <option value="no"<c:if test="${candidate.placed==false}">selected</c:if>>Currently Looking</option>
                                                </select></div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        ...
                                        <div class="col-12 col-md-5 offset-md-1">
                                            <div class="form-group"><label id="email-3">Phone</label><input class="form-control" name="phoneNo"
                                                                                                            type="tel" value="<c:out value='${candidate.canPhoneNo}' default=''/>"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div class="form-group"><label for="cur-pass">Current Password</label><input name="currentPassword"
                                                    class="form-control" type="password" id="cur-pass" placeholder="****"></div>
                                            <div class="form-group"><label for="new-pass">New Password</label><input name="password"
                                                    class="form-control" type="password" id="new-pass"></div>
                                            <div class="form-group"><label for="conf-pass">Confirm Password</label><input name="password-repeat"
                                        ...
                                        <div class="col-12 col-md-5 offset-md-2 d-flex flex-column justify-content-end align-items-start">
                                            ...
                                            <div class="btn-group d-flex" role="group">
                                                ...
                                                <button class="btn btn-dark succ" type="submit" name="submit" value="edit">Save Changes</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                        ...
                                        <div class="card">
                                            <div class="card-header" role="tab">
                                                <h5 class="mb-0"><a data-toggle="collapse" aria-expanded="true"
                                                                    aria-controls="accordion-1 .item-1" href="#accordion-${loop.index} .item-${loop.index}"
                                                                    class="header-btn">${education.institution}</a></h5>
                                            </div>
                                            <div class="collapse show item-1" role="tabpanel" data-parent="#accordion-${loop.index}">
                                                <div class="card-body">
                                                    <form action="<c:url value='/candidate-profile'/>" method="post">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-12 col-md-5">
                                                                <div class="form-group"><label>Institution</label><input name="institution"
                                                                        class="form-control" type="text" value="${education.institution}"></div>
                                                            </div>
                                                            <div class="col-12 col-md-5 offset-md-1">
                                                                <div class="form-group"><label>Education Level</label><select
                                                                        class="form-control level-slc" name="education-lvl" value="${education.level}">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-12 col-md-5">
                                                                <div class="form-group"><label>Subject</label><input name="subject"
                                                                        class="form-control" type="text" value="${education.subject}"></div>
                                                            </div>
                                                            <div class="col-12 col-md-5 offset-md-1">
                                                                <div class="form-group"><label>Start Date</label><input name="start-date"
                                                                        class="form-control" type="date" value="<fmt:formatDate value="${education.startDate}" type="date" pattern="yyyy-MM-dd" />" /></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="col-12 col-md-5">
                                                                <div class="form-group"><label>End Date</label><input name="end-date" value="<fmt:formatDate value="${education.endDate}" type="date" pattern="yyyy-MM-dd" />"
                                                            ...
                                                            <div class="col-12 col-md-5 offset-md-1 d-flex justify-content-around align-items-end">
                                                                <div class="form-group d-flex justify-content-end align-items-end align-content-end save-btns">
                                                                    <div class="btn-group" role="group">
                                                                        ...
                                                                        <button class="btn btn-success succ" type="submit" name="submit" value="edit">Save
                                                                            Changes
                                                                        </button>
                                                                    </div>
                                                                </div>
                            ...
                            <c:forEach var="workHistory" items="${candidate.workHistoryList}" varStatus="loop">
                                ...
                                <div role="tablist" id="accordion-${loop.index}-workHistory">
                                    <div class="card">
                                        <div class="card-header" role="tab">
                                            <h5 class="mb-0"><a data-toggle="collapse" aria-expanded="true"
                                                                aria-controls="accordion-${loop.index}-workHistory .item-1" href="#accordion-${loop.index}-workHistory .item-1"
                                                                class="header-btn">${workHistory.company}</a></h5>
                                        </div>
                                        <div class="collapse show item-1" role="tabpanel" data-parent="#accordion-${loop.index}-workHistory">
                                            <div class="card-body">
                                                <form action="<c:url value='/candidate-profile'/>" method="post">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-12 col-md-5">
                                                            <div class="form-group"><label>Company</label><input name="company"
                                                                    class="form-control" type="text" value="${workHistory.company}"></div>
                                                        </div>
                                                        <div class="col-12 col-md-5 offset-md-1">
                                                            <div class="form-group"><label>Title</label><input name="title"
                                                                    class="form-control" type="text" value="${workHistory.title}"></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="col-12 col-md-5">
                                                            <div class="form-group"><label>Start Date</label><input name="start-date"
                                                                    class="form-control" type="date" value="<fmt:formatDate value="${workHistory.startDate}" type="date" pattern="yyyy-MM-dd" />"></div>
                                                        </div>
                                                        <div class="col-12 col-md-5 offset-md-1">
                                                            <div class="form-group"><label>End Date</label><input name="end-date"
                                                                    class="form-control" type="date" value="<fmt:formatDate value="${workHistory.endDate}" type="date" pattern="yyyy-MM-dd" />"></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-row">
                                                        <div class="col-12 col-md-5">
                                                            <div class="form-group"><label>Reference</label><input name="reference" value="${workHistory.reference}"
