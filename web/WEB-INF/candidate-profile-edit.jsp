                                          ...
                                          <div class="border rounded popup-content">
                                              ...
                                              <form class="ignore popup-form" action="<c:url value='/candidate-profile'/>" method="post">
                                                  ...
                                                  <div class="btn-group d-flex popup-btns" role="group">
                                                      <button class="btn btn-danger" type="submit" name="submit" value="deleteCandidate">Permanently Remove My Account&nbsp;</button>
                                                  </div>
                                              </form>
                                      ...
                                      <div class="row">
                                          <div class="col-12 col-md-5">
                                              <div class="form-group mb-3"><label class="form-label" for="firstName">First
                                                      Name</label><input class="form-control" type="text" maxlength="45" id="firstName"
                                      ...
                                      <div class="row">
                                          <div class="col-12 col-md-5">
                                              <div class="form-group mb-3"><label class="form-label"
                                                                                  ...
                                                                                  class="form-control" type="text" minlength="4" maxlength="45" id="username" name="currentUsername"
                                      ...
                                      <div class="row">
                                          <div class="col-12 col-md-8">
                                              <div class="form-group mb-3"><label class="form-label" id="email"
                                                                                  ...
                                                                                  class="form-control" id="about" maxlength="200" rows="5" placeholder="About Me..."
                                      ...
                                      <div class="row">
                                          <div class="col-12 col-md-5">
                                              ...
                                              <div class="form-group mb-3"><label class="form-label" for="cur-pass">Current
                                                      Password</label><input class="form-control" type="password" minlength="8" maxlength="30" name="currentPassword" id="cur-pass"
                                                                         placeholder="****"></div>
                                              <div class="form-group mb-3"><label class="form-label" for="new-pass">New
                                                      Password</label><input class="form-control" name="password" type="password" minlength="8" maxlength="30" id="new-pass"></div>
                                              <div class="form-group mb-3"><label class="form-label" for="conf-pass">Confirm
                                                      Password</label><input class="form-control" name="password-repeat" type="password" minlength="8" maxlength="30" id="conf-pass">
                                              </div>
                                          </div>
