                            ...
                            <div class="tab-pane fade show active" role="tabpanel" id="tab-1">
                                ...
                                <div class="wrapper">
                                    <div class="remove-acc-alert popup">
                                        <div class="border rounded popup-content"><button class="btn btn-primary btn-block d-flex justify-content-end close" type="button"><i class="icon ion-close-round close-button"></i></button>
                                            <h5 class="text-center">Are you sure you want to remove your Account?</h5>
                                            <form class="ignore popup-form">
                                                <div role="group" class="btn-group d-flex popup-btns"><button class="btn btn-danger" type="submit">Permanently Remove My Account </button></div>
                                            </form>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="collapse show item-1" role="tabpanel" data-parent="#accordion-3">
                                            <div class="card-body">
                                                <form>
                                                    <div class="form-row">
                                                        <div class="col-12 col-md-5"><select class="form-control level-slc" name="education-lvl">
