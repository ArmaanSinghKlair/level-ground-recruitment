                    ...
                    <div class="tab-pane fade show active" role="tabpanel" id="tab-1">
                        ...
                        <div class="wrapper">
                            <div class="remove-acc-alert popup">
                                <div class="border rounded popup-content"><button class="btn btn-primary close" type="button"><i class="icon ion-close-round"></i></button>
                                    <h5>Are you sure you want to remove your Account?</h5>
                                    <form class="ignore popup-form">
                                        <div class="btn-group d-flex popup-btns" role="group"><button class="btn btn-danger" type="submit">Permanently Remove My Account&nbsp;</button></div>
                                    </form>
                                    <p class="lead warming-txt"><em>You can't recover your account after removing it</em></p>
                                </div>
                            </div>
                        </div>
