            ...
            <div class="d-md-flex flex-md-row-reverse">
                ...
                <div class="tab-content edit-content">
                                    ...
                                    <form class="ignore popup-form" action="<c:url value='/candidate-profile'/>"
                                        ...
                                        <div class="btn-group d-flex popup-btns" role="group">
                                            <button class="btn btn-danger" type="submit" name="submit"
                                                    value="deleteCandidate">Permanently Remove My Account&nbsp;
                                            </button>
                                        </div>
                                    </form>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-5">
                                    <div class="form-group mb-3"><label class="form-label" for="firstName">First
                                        Name</label><input class="form-control" type="text" maxlength="45"
                                                           id="firstName"
                                                           name="firstName" value="${candidate.canfirstName}"></div>
                                </div>
                                <div class="col-12 col-md-5 offset-md-1">
                                    <div class="form-group mb-3"><label class="form-label" for="lastName">Last
                                        Name</label><input class="form-control" type="text" maxlength="45" id="lastName"
                                                           name="lastName"
                            ...
                            <div class="row">
                                <div class="col-12 col-md-5">
                                    <div class="form-group mb-3"><label class="form-label"
                                            ...
                                            class="form-control" type="text" minlength="4" maxlength="45" id="username"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-5 offset-md-1">
                                    <div class="form-group mb-3"><label class="form-label"
                                            ...
                                            class="form-control" type="tel" maxlength="10" name="phoneNo"
                            ...
                            <div class="row">
                                <div class="col-12 col-md-8">
                                    <div class="form-group mb-3"><label class="form-label" id="email"
                                            ...
                                            class="form-control" id="about" maxlength="200" rows="5"
                                            placeholder="About Me..."
                                            name="about">${candidate.canDescription}</textarea></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-md-5">
                                    ...
                                    <div class="form-group mb-3"><label class="form-label" for="cur-pass">Current
                                        Password</label><input class="form-control" type="password" minlength="8"
                                                               maxlength="30" name="currentPassword" id="cur-pass"
                                                               placeholder="****"></div>
                                    <div class="form-group mb-3"><label class="form-label" for="new-pass">New
                                        Password</label><input class="form-control" name="password" type="password"
                                                               minlength="8" maxlength="30" id="new-pass"></div>
                                    <div class="form-group mb-3"><label class="form-label" for="conf-pass">Confirm
                                        Password</label><input class="form-control" name="password-repeat"
                                ...
                                <div class="col-12 col-md-5 offset-md-2 d-flex flex-column justify-content-end align-items-start">
                                    ...
                                    <div class="btn-group d-flex" role="group">
                                        ...
                                        <button class="btn btn-dark succ" value="edit" name="submit" type="submit">Save
                                            Changes
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" role="tabpanel" id="tab-4">
                        ...
                        <c:forEach var="candidateSkill" items="${candidate.candidateSkillList}" varStatus="loop">
                                    ...
                                    <div class="accordion-collapse collapse collapsed item-${loop.index}-candidateSkill"
                                        ...
                                        <div class="accordion-body">
                                            <form action="<c:url value='/candidate-profile'/>" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-5">
                                                        <select class="form-select level-slc" name="candidateSkill">
                    ...
                    <div class="tab-pane fade" role="tabpanel" id="tab-5">
                        ...
                        <c:forEach var="candidateRole" items="${candidate.candidateRoleList}" varStatus="loop">
                                    ...
                                    <div class="accordion-collapse collapse collapsed item-${loop.index}-candidateRole"
                                        ...
                                        <div class="accordion-body">
                                            <form action="<c:url value='/candidate-profile'/>" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-5">
                                                        <select class="form-select level-slc" name="candidateRole">
