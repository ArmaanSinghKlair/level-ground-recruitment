...
function SearchBar(_ref) {
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement('input', { type: 'text', name: 'search', id: 'search-input', placeholder: 'Job title or location', ref: searchRef }),
            React.createElement(
                'div',
                { className: 'search-bar__button', onClick: function onClick() {
                        return handleSearch();
                    } },
                React.createElement('img', { src: ENV.CONTEXT_PATH + "/react-inject-scripts/assets/search.svg" })
            )
        ),
        React.createElement(
            'div',
            ...
            React.createElement('input', { type: 'number', min: '0', placeholder: 'Salary Per year', ref: salaryRef })
        ),
        React.createElement(
            'div',
            ...
            Object.keys(searchState).filter(function (key) {
                ...
                return React.createElement(Tag, { name: key, value: searchState[key], onClick: function onClick() {
