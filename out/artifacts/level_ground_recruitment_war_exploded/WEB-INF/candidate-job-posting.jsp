        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav mr-auto flex-md-shrink-0">
                ...
                <li class="nav-item"><a class="nav-link" data-bss-hover-animate="pulse"
                                        href="<c:url value="/candidate-job-posting"/>">Job Posting</a></li>
                <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false"
                                                 data-bs-toggle="dropdown" data-bss-hover-animate="pulse"
                                                 href="#">Services</a>
            ...
            <span class="d-md-flex flex-md-shrink-0 justify-content-md-center align-items-md-center navbar-text actions">
                <a data-bss-hover-animate="pulse" class="login" href="">Profile</a>
                <a data-bss-hover-animate="pulse" class="btn btn-primary action-button" role="button" href="">Logout</a></span>
        </div>
    </div>
</nav>
            ...
            <div role="tablist" id="accordion-1">
                <div class="card">
                    <div class="card-header" role="tab">
                        ...
                        <h3 class="d-flex justify-content-end mb-0"><a data-bs-toggle="collapse" aria-expanded="true"
                                                                       aria-controls="accordion-1 .item-1"
                                                                       href="#accordion-1 .item-1"
                                                                       class="more-btn accordion-button"></a></h3>
                    </div>
                    <div class="collapse show item-1" role="tabpanel" data-bs-parent="#accordion-1">
                        <div class="card-body">
                            <div class="shadow job-post">
                                ...
                                <div>
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                        incididunt ut labore et dolore magna aliqua. Venenatis cras sed felis eget velit
                                        aliquet sagittis id. Diam phasellus vestibulum lorem sed risus ultricies. Sit
                                        amet dictum sit amet justo donec enim. Egestas dui id ornare arcu odio ut.<br>
                                    </p>
                                    <hr>
                                </div>
                                <div>
                                ...
                                <form class="d-flex justify-content-end">
                                    <button class="btn apply-btn" type="submit">Apply Now</button>
                                </form>
                            </div>
                        </div>
                    </div>
